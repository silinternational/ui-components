...
- **SearchableSelect:** listen for up and down arrow keys to set to first or last option respectively when a valid option is not selected ([96abc5f](https://github.com/silinternational/ui-components/commit/96abc5f7d8ffa9f5d797c9b5fce0ccc717a3097e))
