...
If you are using typescript you will need to run `npm i -D tslib` to avoid a material-components-web type error. You should also include the following compilerOptions in your tsconfig.json file.
