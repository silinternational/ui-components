<script>
import { Button, Card } from '../index.mjs'
...
<Story name="Secondary" args={copyAndModifyArgs(args, { secondary: 'secondary' })} />

<Story name="Color" args={copyAndModifyArgs(args, { color: 'yellow' })} />
